...
class startButton(unit):
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load("images/STARTBUTTON.png").convert()
...
class RetryButton(unit):
    def __init__(self, x, y):
        unit.__init__(self,x, y)
        self.image = pygame.image.load("images/TRYAGAIN.png")
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
    def display(self):
...
class PlayAgainButton(unit):
    def __init__(self, x, y):
        unit.__init__(self,x, y)
        self.image = pygame.image.load("images/PLAYAGAIN.png")
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
    def display(self):
...
class Hero(unit):
    def __init__(self, x, y):
        ...
        self.lives = 3
        self.lspeed = 0
        self.image = pygame.image.load("images/myhero.png")
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
    def display(self):
...
class enemy(enemies):
    def __init__(self, x, y, health):
        enemies.__init__(self, x, y, health)
        self.image = pygame.image.load("images/Enemies/MyEnemy.png")
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
...
class enemy3(enemies):
    def __init__(self, x, y, health):
        enemies.__init__(self, x, y, health)
        self.image = pygame.image.load("images/Enemies/enemyBlack3.png")
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
...
class enemy4(enemies):
    def __init__(self, x, y, health):
        enemies.__init__(self, x, y, health)
        self.image = pygame.image.load("images/Enemies/enemyRed2.png")
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
...
class enemy5(enemies):
    def __init__(self, x, y, health):
        enemies.__init__(self, x, y, health)
        self.image = pygame.image.load("images/Enemies/enemyBlue4.png")
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
    def display(self):
...
def main():
    ...
    startscreen = pygame.image.load("images/SpaceShooterStartpage.png")
